...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>Easily conrol your<br className='sm:block hidden'/> billing & invoicing</h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      Stay organized, ensure accuracy, and focus on what matters most – growing your business. 
      With our seamless billing and invoicing features, 
